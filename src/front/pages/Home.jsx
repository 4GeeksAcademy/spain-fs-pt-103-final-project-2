            ...
            <div className="home-graph-container">
              {pesosSemanal.length > 0 ? (
                <div className="home-line-chart">
                  <svg width={anchoGrafica} height={altoGrafica} className="home-chart-svg">
                    {/* Cuadrícula */}
                    <defs>
                    ...
                    {userData.metaPeso && (
                      <g>
                        <line
                          x1={margenIzq}
                          y1={margenTop + altoChart - ((userData.metaPeso - minY) / rangoY) * altoChart}
                          x2={margenIzq + anchoChart}
                          y2={margenTop + altoChart - ((userData.metaPeso - minY) / rangoY) * altoChart}
                          stroke="#10b981"
                          strokeWidth="2"
                          strokeDasharray="8,4"
                        />
                        <text
                          ...
                          y={margenTop + altoChart - ((userData.metaPeso - minY) / rangoY) * altoChart - 5}
                          textAnchor="end"
                          fontSize="12"
                          fill="#10b981"
                          fontWeight="600"
